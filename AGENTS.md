# AGENTS.md — ImplusOS Project Guide for Claude Code
...
- **Application convention**: Each app lives in `Userland/Application/{SystemApps,UserApps}/com.ImplusOS.<name>/` with its own `Makefile`.
