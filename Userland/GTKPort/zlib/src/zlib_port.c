...
static const unsigned long crc32_table[256] = {
    ...
    0xE3630B12UL, 0x94643B84UL, 0x0D6D6A3EUL, 0x7A6D7CA8UL,
    ...
    0x9B64C2B0UL, 0xEC63F226UL, 0x7562439CUL, 0x026B510AUL,
    0x9C0906A9UL, 0xEB0E363FUL, 0x72076785UL, 0x05005713UL,
    0x95BF4A82UL, 0xE2B87A14UL, 0x7BB12BAEUL, 0x0CB61B38UL,
    0x92D28E9BUL, 0xE5D5BE0DUL, 0x7CDCEFB7UL, 0x0BDBDF21UL,
    0x86D3D2D4UL, 0xF1D4E242UL, 0x68DDB3F8UL, 0x1FDA836EUL,
    0x81BE16CDUL, 0xF6B9265BUL, 0x6FB077E1UL, 0x18B74777UL,
    0x88085AE6UL, 0xFF0F6B70UL, 0x66063BCAUL, 0x11010B5CUL,
...
int deflateInit2_(z_streamp strm, int level, int method, int windowBits,
    ...
    (void)level;(void)method;(void)windowBits;(void)memLevel;(void)strategy;
...
int deflate(z_streamp strm, int flush) {
    ...
    return (strm->avail_in == 0 && flush == Z_FINISH) ? Z_STREAM_END : Z_OK;
}
...
int inflate(z_streamp strm, int flush) {
    ...
    return (strm->avail_in == 0) ? Z_STREAM_END : Z_OK;
}
